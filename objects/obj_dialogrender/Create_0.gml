...
dialogs = [
	[
		[DIAG_TYPE_TEXT, "[wave][rainbow]Hello, World![/rainbow][/wave] This is a test of the textbox! 0.5 Is the normal speed of a textbox, but you can change it to be...", DIAG_CHAR_PLACEHOLDER, DIAG_FACE_NEUTRAL, 0.5],
